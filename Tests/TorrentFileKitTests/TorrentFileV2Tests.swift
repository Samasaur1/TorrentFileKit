...
struct TorrentFileV2Tests {
    ...
    struct InfoDictTests {
        ...
        struct BitForBitIdenticalTests {
            @Test
            func pureSingleFileV2DataToInfoDictToData() async throws {
            ...
            @Test
            func pureMultipleFileV2DataToInfoDictToData() async throws {
            ...
            @Test
            func pureSingleFileHybridDataToInfoDictToData() async throws {
            ...
            @Test
            func pureMultipleFileHybridDataToInfoDictToData() async throws {
